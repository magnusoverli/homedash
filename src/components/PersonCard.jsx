  ...
  const getTypeDisplayInfo = type => {
    const typeMap = {
      manual: {
        ...
        description: 'Activities you created manually',
        icon: '✏️',
      },
      spond: {
        name: 'Spond Activities',
        description: 'Sports activities from Spond',
        icon: '⚽',
      },
      school_schedule: {
        name: 'School Schedule',
        description: 'Regular school periods',
        icon: '🏫',
      },
      school_activity: {
        name: 'School Activities',
        description: 'Special school events',
        icon: '🎓',
      },
      category_work: {
      ...
      category_family: {
        ...
        description: 'Family time and events',
        icon: '👨‍👩‍👧',
      },
      category_meal: {
        name: 'Meal Activities',
        description: 'Eating and food-related',
        icon: '🍽️',
      },
      category_personal: {
    ...
    <div className="person-card">
      <div className="person-card-header">
        ...
        <button
          ...
          aria-label={`View settings for ${member.name}`}
        >
          <PaletteIcon size={16} color="#b781ff" />
        </button>
      </div>
          ...
          <div className="modal-section">
            <div className="section-header">
              ...
              <p className="section-description">
                Customize colors for different types of activities in{' '}
            ...
            {typesPresent.length > 0 ? (
              ...
              <div className="no-activities-message">
                <p>
                  No activities found for this week. Add some activities to
